...
# Load model
model = load_model('D:/AI/finalProject/model/vehicle2.h5')
...
def home_tab():
    ...
    if uploaded_file is not None:
        ...
        if(click):
            ...
            cv2.putText(img, text, (10, img.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2) 
